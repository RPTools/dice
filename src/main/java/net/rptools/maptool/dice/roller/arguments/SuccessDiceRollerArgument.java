...
public class SuccessDiceRollerArgument extends AbstractDiceRollerArgument {

  private static final ModifyDieRollFlags modifyDieRollFlags =
      new ModifyDieRollFlags(
          Collections.singleton(DieRoll.DieRollFlags.SUCCESS),
          Arrays.asList(DieRoll.DieRollFlags.FAILURE, DieRoll.DieRollFlags.FUMBLE));

  public SuccessDiceRollerArgument(DiceExpressionNode value, String operator) {

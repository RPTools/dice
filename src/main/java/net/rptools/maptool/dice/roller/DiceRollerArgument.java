...
/**
 * This class represents modifier arguments to a dice roll. Arguments are of the form <i>name</i>[<i>operator</i>][<i>number</i>]
 */
public class DiceRollerArgument {
    ...
    @SuppressWarnings("OptionalUsedAsFieldOrParameterType") private final OptionalInt number;
     ...
     *            The name of the argument.
     * @param op
     *            The operator that is part of the argument.
     * @param num
     *            The number that is part of the argument.
     */

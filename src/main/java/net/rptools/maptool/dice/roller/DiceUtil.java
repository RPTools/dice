...
public class DiceUtil {
	 ...
	 *
	 * @param lower
	 *            The lower bound (inclusive) for the random number.
	 * @param upper
	 *            The upper bound (inclusive) for the random number..
	 *
	 * @return a random int.
	 */
	@SuppressWarnings("WeakerAccess")
	 ...
	 * @param lower
	 *            The lower bound (inclusive) for the random numbers;
	 * @param upper
	 *            The upper bound (inclusive) for the random numbers;
	 *
	 ...
	 *
	 * @param number
	 *            The number of integers to return in the array.
	 * @param lower
	 *            The lower bound (inclusive) for the random numbers.
	 * @param upper
	 *            The upper bound (inclusive) for the random numbers.

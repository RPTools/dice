 ...
 *
 * Classes implementing this interface need to be able to handle the formatting of more than one expression sequentially, formatting the multiple expression in which ever way is suitable for the
 * output.
 *
 * {@link #start()} will be called to signal the details from this point onwards are for a new expression. {@link #end()} will be called to signal all the details for an expression have been sent.
 */
public interface ResultFormatter {
	 ...
	 *
	 * @param result
	 *            The over all result of the expression.
	 */

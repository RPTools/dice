...
class DiceExprResultTest {
    ...
    void subtractStringAndInt() {
        assertThrows(IllegalArgumentException.class , () ->
                DiceExprResult.subtract(DiceExprResult.getStringResult("hello"), DiceExprResult.getIntResult(3))
        );
        assertThrows(IllegalArgumentException.class, () ->
                DiceExprResult.subtract(DiceExprResult.getIntResult(-4), DiceExprResult.getStringResult("test"))
        );
    }
    ...
    void subtractStringAndDouble() {
        assertThrows(IllegalArgumentException.class, () ->
                DiceExprResult.subtract(DiceExprResult.getStringResult("hello"), DiceExprResult.getDoubleResult(3.2))
        );
        assertThrows(IllegalArgumentException.class, () ->
                DiceExprResult.subtract(DiceExprResult.getDoubleResult(-4.2), DiceExprResult.getStringResult("test"))
        );
    }
    ...
    void divideStrings() {
        assertThrows(IllegalArgumentException.class, () ->
                DiceExprResult.divide(DiceExprResult.getStringResult("hello"), DiceExprResult.getStringResult("world"))
        );
        assertThrows(IllegalArgumentException.class, () ->
                DiceExprResult.divide(DiceExprResult.getStringResult(""), DiceExprResult.getStringResult("test"))
        );
    }
    ...
    void divideStringAndInt() {
        assertThrows(IllegalArgumentException.class, () ->
                DiceExprResult.divide(DiceExprResult.getStringResult("hello"), DiceExprResult.getIntResult(3))
        );
        assertThrows(IllegalArgumentException.class, () ->
                DiceExprResult.divide(DiceExprResult.getIntResult(-4), DiceExprResult.getStringResult("test"))
        );
        assertThrows(IllegalArgumentException.class, () ->
                DiceExprResult.divide(DiceExprResult.getIntResult(4), DiceExprResult.getStringResult("test"))
        );
        assertThrows(IllegalArgumentException.class, () ->
                DiceExprResult.divide(DiceExprResult.getIntResult(0), DiceExprResult.getStringResult("test"))
        );
    }
    ...
    void divideStringAndDouble() {
        assertThrows(IllegalArgumentException.class, () ->
                DiceExprResult.divide(DiceExprResult.getStringResult("hello"), DiceExprResult.getDoubleResult(3.2))
        );
        assertThrows(IllegalArgumentException.class, () ->
                DiceExprResult.divide(DiceExprResult.getDoubleResult(-4.2), DiceExprResult.getStringResult("test"))
        );
    }
    ...
    void multiplyStrings() {
        assertThrows(IllegalArgumentException.class, () ->
                DiceExprResult.multiply(DiceExprResult.getStringResult("hello"), DiceExprResult.getStringResult("world"))
        );
        assertThrows(IllegalArgumentException.class, () ->
                DiceExprResult.multiply(DiceExprResult.getStringResult(""), DiceExprResult.getStringResult("test"))
        );
    }
    ...
    void subtractUndefinedAndString() {
        assertThrows(IllegalArgumentException.class, () ->
                DiceExprResult.subtract(DiceExprResult.UNDEFINED, DiceExprResult.getStringResult("hello"))
        );

        assertThrows(IllegalArgumentException.class, () ->
                DiceExprResult.subtract(DiceExprResult.getStringResult("hello"), DiceExprResult.UNDEFINED)
        );
    }
    ...
    void multiplyUndefinedAndString() {
        assertThrows(IllegalArgumentException.class, () ->
                DiceExprResult.multiply(DiceExprResult.UNDEFINED, DiceExprResult.getStringResult("hello"))
        );

        assertThrows(IllegalArgumentException.class, () ->
                DiceExprResult.multiply(DiceExprResult.getStringResult("hello"), DiceExprResult.UNDEFINED)
        );
    }
    ...
    void divideUndefinedAndString() {
        assertThrows(IllegalArgumentException.class, () ->
                DiceExprResult.divide(DiceExprResult.UNDEFINED, DiceExprResult.getStringResult("hello"))
        );

        assertThrows(IllegalArgumentException.class, () ->
                DiceExprResult.divide(DiceExprResult.getStringResult("hello"), DiceExprResult.UNDEFINED)
        );
    }
    ...
    void negateUndefined() {
        assertThrows(IllegalArgumentException.class, () ->
                DiceExprResult.negate(DiceExprResult.UNDEFINED)
        );
    }
